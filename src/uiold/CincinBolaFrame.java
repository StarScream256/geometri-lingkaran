 ...
 * @author asus
 */
public class CincinBolaFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CincinBolaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
